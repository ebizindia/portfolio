<tr id="record_row_<?php echo $this->body_template_data[$mode_index]['records'][$i_ul]['id']; ?>" class="responsive-task-cat">
  ...
  <td>
	<div style="width:80px;text-align:left;" class="icons_container_block">
		...
		<a href="#" class="btn btn-xs btn-danger record-delete-button rounded ml-2" data-in-mode="list-mode" data-recid="<?php echo $this->body_template_data[$mode_index]['records'][$i_ul]['id']; ?>" data-groupname="<?php echo \eBizIndia\_esc($this->body_template_data[$mode_index]['records'][$i_ul]['name'], true); ?>" data-rel='tooltip' title="Delete customer group">
