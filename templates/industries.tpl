...
if($this->body_template_data['mode'] == 'getList'){
	...
	if($this->body_template_data[$mode_index]['filtertext']!=''){
		...
		echo '<tr>
				<td align=\'center\' class="label-yellow padding-10 filter-row" colspan="3" id="rearch_data">',$this->body_template_data[$mode_index]['filtertext'],'  <a class="clear-filter" onclick="industryfuncs.clearSearch();">Clear Filter</a>
				</td>
			</tr>';
	}
	...
	if($this->body_template_data[$mode_index]['records_count']==0){
		...
		for($i_ul=0; $i_ul<$this->body_template_data[$mode_index]['records_count']; $i_ul++){
				...
				require CONST_THEMES_TEMPLATE_INCLUDE_PATH.'industries-row.tpl';
...
<div class="row">
    <div id='rec_list_container' class="col-12 mt-3 mb-2">
        ...
        <div class="card-body">
        	...
        	<div class="row">
                <div class="col-8 "><h4 class="row pg_heading_line_ht  ">Industries&nbsp;<span id="heading_rec_cnt" style="color: #0c0c0cab;" >0</span> </h4></div>
                <div class="col-4 text-right">
                	<div class="row btns-user-add" style="float:right;">
						...
						?>		
								<a href="industries.php#mode=addrec" class="btn btn-success  record-add-button  rounded"  id="add-record-button"><img src="images/plus.png" class="custom-button-small" alt="Plus"> <span class="hide_in_mobile"  >Add Industries</span> </a>
        ...
        <div class="panel-search d-none pb-2">
			<?php include CONST_THEMES_TEMPLATE_INCLUDE_PATH.'industries-search-form-basic.tpl'; ?>
		</div>
			...
			<table id="recs-list" class="table table-striped table-bordered table-hover" style="width: auto;" >
				<thead class="thead">
					<tr>
						...
						<th class='sortable' id="colheader_industry" width="300" ><span class="pull-left">Industry</span><i  class='fa fa-sort pull-right' ></i></th>
	...
	<div class="col-12 mt-3 mb-2 d-none"  id='rec_detail_add_edit_container'   >
		<?php require_once CONST_THEMES_TEMPLATE_INCLUDE_PATH.'industries-add.tpl';	?>
	</div>
