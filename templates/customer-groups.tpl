...
if($this->body_template_data['mode'] == 'getList'){
	...
	if($this->body_template_data[$mode_index]['filtertext']!=''){
		...
		echo '<tr>
				<td align=\'center\' class="label-yellow padding-10 filter-row" colspan="3" id="rearch_data">',$this->body_template_data[$mode_index]['filtertext'],'  <a class="clear-filter" onclick="customergroupfuncs.clearSearch();">Clear Filter</a>
				</td>
			</tr>';
	}
	...
	if($this->body_template_data[$mode_index]['records_count']==0){
		...
		for($i_ul=0; $i_ul<$this->body_template_data[$mode_index]['records_count']; $i_ul++){
				...
				require CONST_THEMES_TEMPLATE_INCLUDE_PATH.'customer-groups-row.tpl';
...
<div class="row">
    <div id='rec_list_container' class="col-12 mt-3 mb-2">
        ...
        <div class="card-body">
        	...
        	<div class="row">
                <div class="col-8 "><h4 class="row pg_heading_line_ht">Customer Groups&nbsp;<span id="heading_rec_cnt" style="color: #0c0c0cab;" >0</span> </h4></div>
                <div class="col-4 text-right">
                	<div class="row btns-user-add" style="float:right;">
						...
						?>		
								<a href="customer-groups.php#mode=addrec" class="btn btn-success record-add-button rounded" id="add-record-button"><img src="images/plus.png" class="custom-button-small" alt="Plus"> <span class="hide_in_mobile">Add Customer Groups</span> </a>
        ...
        <div class="panel-search d-none pb-2">
			<?php include CONST_THEMES_TEMPLATE_INCLUDE_PATH.'customer-groups-search-form-basic.tpl'; ?>
		</div>
	...
	<div class="col-12 mt-3 mb-2 d-none" id='rec_detail_add_edit_container'>
		<?php
			if($this->body_template_data['can_add']===true || $this->body_template_data['can_edit']===true)
				require_once CONST_THEMES_TEMPLATE_INCLUDE_PATH.'customer-groups-add.tpl';
		?>
	</div>
