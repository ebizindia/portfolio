...
if ($this->body_template_data['mode'] == 'getList') {
    ...
    if ($this->body_template_data[$mode_index]['filtertext'] != '') {
        ...
        echo '<tr>
                <td align="center" class="label-yellow padding-10 filter-row" colspan="5" id="search_data">',
                $this->body_template_data[$mode_index]['filtertext'],
                ' <a class="clear-filter" onclick="customers.clearSearch();">Clear Filter</a>
                </td>
              </tr>';
    }
    ...
    if ($this->body_template_data[$mode_index]['records_count'] == 0) {
        ...
        for ($i_ul = 0; $i_ul < $this->body_template_data[$mode_index]['records_count']; $i_ul++) {
            require CONST_THEMES_TEMPLATE_INCLUDE_PATH . 'customers-row.tpl';
        }
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <h4 class="row pg_heading_line_ht">
                                ...
                                <a id="export_customers" href="" download="customers.csv" class="nopropagate ml-1 d-none">
                                    <img src="images/dnld.png" alt="Export customers list as CSV" width="22" height="22">
                                </a>
                            </h4>
                        </div>
                        <div class="col-4 text-right">
                            <div class="row btns-user-add" style="float:right;">
                                ...
                                <a href="customers.php#mode=addrec" class="btn btn-success record-add-button rounded" id="add-record-button">
                                    <img src="images/plus.png" class="custom-button-small" alt="Plus"> 
                                    <span class="hide_in_mobile">Add Customer</span>
                                </a>
                                <?php } ?>
                            </div>
                        </div>
                ...
                <div class="panel-search d-none pb-2">
                    <?php include CONST_THEMES_TEMPLATE_INCLUDE_PATH . 'customers-search-form-basic.tpl'; ?>
                </div>
                <div class="responsive-block-table for-cat">
                    <div class="panel-body table-responsive">
                        <table id="recs-list" class="table table-striped table-bordered table-hover" style="width: auto;">
                            <thead class="thead">
                                <tr>
                                    <th width="40"><span>Action</span></th>
                                    <th class='sortable' id="colheader_name" width="300">
                                        <span class="pull-left">Customer</span>
                                        <i class='fa fa-sort pull-right'></i>
                                    </th>
                                    <th class='sortable' id="colheader_customer-group-name" width="300">
                                        <span class="pull-left">Customer Group</span>
                                        <i class='fa fa-sort pull-right'></i>
                                    </th>
                                    <th class='sortable' id="colheader_customer_industry" width="300">
                                        <span class="pull-left">Customer Industry</span>
                                        
                                    </th>
                                    <th width="100" id="colheader_active">
    ...
    <div class="col-12 mt-3 mb-2 d-none" id='rec_detail_add_edit_container'>
        <?php
            if($this->body_template_data['can_add']===true || $this->body_template_data['can_edit']===true)
                require_once CONST_THEMES_TEMPLATE_INCLUDE_PATH . 'customers-add.tpl';
        ?>
    </div>
